...
module.exports = {
  ...
  async execute(interaction) {
    ...
    await interaction.reply({
      content: "<:tick:1415646570191261727> Reaction roles system sent!",
    });
    ...
    const embed = new EmbedBuilder()
      ...
      .setDescription(
        "React below to receive notifications for specific events!",
      )
      .setColor(16607015)
      .setThumbnail(
      ...
      .addFields(
        {
          name: ":bell: Active",
          value:
            "Stay in the loop with general server updates and announcements.",
        },
        {
          name: ":airplane: Flight Announcement",
          value: "Get alerts about upcoming flight being hosted.",
        },
        {
          name: ":clipboard: Application Pings",
          value:
            "Stay notified when applications open for department positions.",
        },
        {
          name: ":books: Polls Ping",
          value: "Vote in community polls and help shape decisions.",
        },
        {
          name: ":tada: Giveaway Pings",
          value: "Get updates on exciting giveaways and how to join.",
        },
        {
          name: ":tools: Development Pings",
          value:
            "Be the first to know about updates and progress in development.",
        },
        {
          name: ":rotating_light: Punishment Pings",
          value: "Receive alerts regarding punishment logs.",
        },
      );

    const channel = await interaction.guild.channels.fetch(
      CHANNEL_REACTION_ROLES,
    );
    ...
    const fs = require("fs");
    fs.writeFileSync(
      "./reactionMessage.json",
      JSON.stringify({ id: message.id, emojiRoleMap }, null, 2),
    );
  },
};
